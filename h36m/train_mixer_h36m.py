...
def train(model, model_name, args):
    ...
    for epoch in range(args.n_epochs):
        ...
        for cnt, batch in tqdm(enumerate(data_loader), total=len(data_loader)):
            ...
            # a=batch.detach().cpu().numpy().reshape(50,35,32,3)
            n += batch_dim
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='../checkpoints/h36m',
    ...
    if args.loss_type == 'mpjpe':
        ...
        parser_mpjpe.add_argument('--num_blocks', default=3, type=int, required=False)#ori_num=4
