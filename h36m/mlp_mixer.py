...
class Graph():
    ...
    def get_edge(self):
        ...
        bone_link = [(0, 1), (1, 2), (2, 3), (4, 5), (5, 6), (6, 7), (8, 9),
...
class MlpBlock(nn.Module):
    def __init__(self, mlp_hidden_dim, mlp_input_dim, mlp_bn_dim, activation='gelu', regularization=0,
        ...
        self.gc1 = TGraphConvolution(16,32, node_n=22, seq_len=10, bias=True)
        self.gc2 = TGraphConvolution(32, 16, node_n=22, seq_len=10, bias=True)
...
class SMlpBlock(nn.Module):
    def __init__(self, mlp_hidden_dim, mlp_input_dim, mlp_bn_dim, activation='gelu', regularization=0,
        ...
        # self.fc1 = nn.Linear(self.mlp_input_dim, self.mlp_input_dim)
        # self.fc1 = nn.Linear(self.mlp_input_dim, self.mlp_hidden_dim)
        self.gc1 = SGraphConvolution(16,16, node_n=22, seq_len=10, bias=True)
        self.gc2 = SGraphConvolution(16, 16, node_n=22, seq_len=10, bias=True)
        # self.fc2 = nn.Linear(self.mlp_hidden_dim, self.mlp_input_dim)
        if regularization > 0.0:
            self.reg1 = nn.Dropout(regularization)
            self.reg2 = nn.Dropout(regularization)
...
class MlpMixer(nn.Module):
    def __init__(self, num_classes, num_blocks, hidden_dim, tokens_mlp_dim,
        ...
        self.sgcn = SGraphConvolution(3, 16, node_n=22, seq_len=10, bias=True)
        ...
        self.sgcn_out = SGraphConvolution(16, 3, node_n=22, seq_len=25, bias=True)
